...
| -natnet                       |                                                                              | Use user mode networking backend for VirtIO Net (default, no root/TAP needed). Aliases: `-nat`, `-usernet`, `-user`, `-usermodenet`, `-usermode` |
...
| -no-ipv6                      |                                                                              | Disable IPv6 user mode networking (ICMPv6/UDPv6/TCPv6 and router advertisements are suppressed) |
| -ipv6                         |                                                                              | Enable IPv6 user mode networking (default)                     |
| -hostfwd [spec]               |                                                                              | Add a user mode networking port forward (requires `-usernet`/`-natnet`). Format: `tcp\|udp::hostport-[guestip]:guestport`, e.g. `-hostfwd tcp::2222-:22`. Can be repeated. |
